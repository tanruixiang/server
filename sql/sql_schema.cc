...
const LEX_CSTRING mariadb_schema_name= {STRING_WITH_LEN("mariadb_schema")};
const LEX_CSTRING oracle_schema_name= {STRING_WITH_LEN("oracle_schema")};
const LEX_CSTRING maxdb_schema_name= {STRING_WITH_LEN("maxdb_schema")};

Schema        mariadb_schema(mariadb_schema_name);
Schema_oracle oracle_schema(oracle_schema_name);
Schema_maxdb  maxdb_schema(maxdb_schema_name);
